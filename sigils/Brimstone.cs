...
{
	private static AbilityManager.FullAbility AddBrimstone()
	{
		// setup ability
...
public class Brimstone : AbilityBehaviour
{
	...
	private bool _willDealDamageToOpponent;
	...
	public override IEnumerator OnSlotTargetedForAttack(CardSlot slot, PlayableCard attacker)
	{
		...
		this._willDealDamageToOpponent = slot.Card && !BoardManager.Instance.GetCardQueuedForSlot(slot);
		yield break;
	}
}
