...
{
	private AbilityManager.FullAbility AddAbilityExodia()
	{
		AddCardExodiaArms();
	...
	private static void AddCardExodiaArms()
	{
		...
		List<CardMetaCategory> metaCategories = new() { CardMetaCategory.TraderOffer };
...
public class Exodia : AbilityBehaviour
{
	...
	private bool _rightArmInCorrectSlot;
	private bool _leftArmInCorrectSlot;
	...
	public override IEnumerator OnOtherCardAssignedToSlot(PlayableCard otherCard)
	{
		...
		if (this.DoAdjacentSlotsHaveArms(otherCard))
		{
			...
			TextDisplayer.Instance.StartCoroutine(
				TextDisplayer.Instance.ShowUntilInput(
					...
					DialogueEvent.Speaker.Bonelord
				)
			);
