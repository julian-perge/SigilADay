...
{
	private AbilityManager.FullAbility AddNest()
	{
...
public class Nest : AbilityBehaviour
{
	...
	public override bool RespondsToTakeDamage(PlayableCard source)
	{
		...
		_originalDeckCards ??= CardDrawPiles.Instance.Deck.cards;
		return true;
	}
	...
	public override IEnumerator OnTakeDamage(PlayableCard source)
	{
		...
		CardDrawPiles.Instance.Deck.cards = new List<CardInfo>(TutorCards);

		// now tutor
		yield return CardDrawPiles.Instance.Deck.Tutor();
		...
		CardDrawPiles.Instance.Deck.cards = _originalDeckCards;
